...
const UserRecentEvent_1 = require("./UserRecentEvent");
...
function UserInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'recent_events': (json['recent_events'].map(UserRecentEvent_1.UserRecentEventFromJSON)),
...
function UserInfoToJSON(value) {
    ...
    return {
        ...
        'recent_events': (value.recent_events.map(UserRecentEvent_1.UserRecentEventToJSON)),
