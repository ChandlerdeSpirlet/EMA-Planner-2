...
class User {
    ...
    getUserByIdentifier(identifier) {
        return __awaiter(this, void 0, void 0, function* () {
            this._apiKeyCheck();
            try {
                const response = yield __classPrivateFieldGet(this, _User_client, "f").listPaginatedUsers({
                    appId: __classPrivateFieldGet(this, _User_appID, "f"),
                    limit: 1,
                ...
                if (!users.length) {
                    throw new PassageError_1.PassageError('Could not find user with that identifier.');
                }
                return this.get(users[0].id);
            }
            catch (err) {
                throw new PassageError_1.PassageError('Could not fetch user by identifier.', err);
            }
        });
    }
    /**
