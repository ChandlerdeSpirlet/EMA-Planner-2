 ...
 */
export function instanceOfGithubUserSocialConnection(value) {
    let isInstance = true;
...
export function GithubUserSocialConnectionFromJSON(json) {
    return GithubUserSocialConnectionFromJSONTyped(json, false);
}
export function GithubUserSocialConnectionFromJSONTyped(json, ignoreDiscriminator) {
...
export function GithubUserSocialConnectionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
