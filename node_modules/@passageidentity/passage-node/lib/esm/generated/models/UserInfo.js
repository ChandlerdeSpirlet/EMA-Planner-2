 ...
 */
import { UserRecentEventFromJSON, UserRecentEventToJSON, } from './UserRecentEvent';
...
export function UserInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'recent_events': (json['recent_events'].map(UserRecentEventFromJSON)),
...
export function UserInfoToJSON(value) {
    ...
    return {
        ...
        'recent_events': (value.recent_events.map(UserRecentEventToJSON)),
