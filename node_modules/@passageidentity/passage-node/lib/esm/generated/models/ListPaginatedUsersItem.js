 ...
 */
export function instanceOfListPaginatedUsersItem(value) {
    let isInstance = true;
...
export function ListPaginatedUsersItemFromJSON(json) {
    return ListPaginatedUsersItemFromJSONTyped(json, false);
}
export function ListPaginatedUsersItemFromJSONTyped(json, ignoreDiscriminator) {
...
export function ListPaginatedUsersItemToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
