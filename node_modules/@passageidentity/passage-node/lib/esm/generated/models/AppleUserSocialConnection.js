 ...
 */
export function instanceOfAppleUserSocialConnection(value) {
    let isInstance = true;
...
export function AppleUserSocialConnectionFromJSON(json) {
    return AppleUserSocialConnectionFromJSONTyped(json, false);
}
export function AppleUserSocialConnectionFromJSONTyped(json, ignoreDiscriminator) {
...
export function AppleUserSocialConnectionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
