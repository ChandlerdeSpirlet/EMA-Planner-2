...
import { CreateUserRequestToJSON, ListPaginatedUsersResponseFromJSON, UpdateUserRequestToJSON, UserResponseFromJSON, } from '../models/index';
/**
 *
 */
export class UsersApi extends runtime.BaseAPI {
     ...
     * List Users
     */
    listPaginatedUsersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.appId === null || requestParameters.appId === undefined) {
     ...
     * List Users
     */
    listPaginatedUsers(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.listPaginatedUsersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
